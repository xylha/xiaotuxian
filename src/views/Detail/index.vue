...
import ImageView from '@/componentsProject/imageView/index.vue'
import XtuSku from '@/componentsProject/XtxSku/index.vue'
...
// 加入购物车
const add = () => {
  if (skuObj.value.skuId) { // 选择了规格
    
    cartStore.addCart({
      id: detailList.value.id, // 商品id
      name: detailList.value.name, // 商品名称
      picture: detailList.value.mainPictures[0],
      price: detailList.value.price, // 商品价格
...
<template>
  <div class="xtx-goods-page">
    <div class="container" v-if="detailList.length !== 0">
      <div class="bread-container">
        <el-breadcrumb separator=">">
          <el-breadcrumb-item :to="{ path: '/' }">首页</el-breadcrumb-item>
          <!-- 
            错误原因：goods一开始{}  {}.categories -> undefined  -> undefined[1]
            1. 可选链的语法 ?. (detailList.categories?.[1].id)
      ...
      <div class="info-container">
        <div>
          <div class="goods-info">
            <div class="media">
              <!-- 图片预览区 -->
              <XtuImageView :imageList = "detailList.mainPictures" />
              <!-- 统计数量 -->
            ...
            <div class="spec">
              ...
              <!-- sku组件 -->
              <XtuSku :goods="detailList"  @change="skuChange" />
              <!-- 数据组件 -->
            ...
            <div class="goods-article">
              ...
              <div class="goods-tabs">
                ...
                <div class="goods-detail">
                  ...
                  <!-- 图片 -->
                  <img v-for="p in detailList.details.pictures" :key="p" :src="p" alt=""/>
                </div>
              </div>
            </div>
            <!-- 24热榜+专题推荐 -->
